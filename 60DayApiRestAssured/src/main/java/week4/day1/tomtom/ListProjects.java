...
public class ListProjects extends TomTomBasics {
	@Test
	public void listProjects() {
		...
		List<Map<Object, Object>> custidlist = jsonresp.getList("projects");
    	for (Map<Object, Object> map : custidlist) {
			if (map.containsValue(project_id)) {
				System.out.println(project_id+" is listed in getcustomers response "+ map.containsValue(project_id) );
			}
		}
